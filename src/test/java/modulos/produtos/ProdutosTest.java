...
public class ProdutosTest {
    ...
    public void beforeEach() {
        // Abrir o navegador
        System.setProperty("webdriver.chrome.driver", "C:\\drivers\\chromedriver_win32_v114\\chromedriver.exe");
    ...
    public void testPossoAdicionarProdutosComValorDeUmCentavo() {
        String mensagemApresentada = new LoginPage(navegador)
                ...
                .submeterFormularioDeLogin()
                .acessarFormularioAdicaoNovoProduto()
                .informarNomeDoProduto("Bala de Goma")
                .informarValorDoProduto("001")
                .informarCoresDoProduto("colorido")
